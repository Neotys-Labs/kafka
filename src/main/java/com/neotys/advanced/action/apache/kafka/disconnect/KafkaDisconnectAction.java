...
public final class KafkaDisconnectAction implements Action {

    private static final String BUNDLE_NAME = "com.neotys.advanced.action.apache.kafka.disconnect.bundle";
    private static final String DISPLAY_NAME = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayName");
    private static final String DISPLAY_PATH = ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("displayPath");
    private static final ImageIcon DISPLAY_ICON;

    static {
		URL iconURL = KafkaDisconnectAction.class.getResource(ResourceBundle.getBundle(BUNDLE_NAME, Locale.getDefault()).getString("iconPath"));
        if (iconURL != null) {
    ...
    public List<ActionParameter> getDefaultActionParameters() {
        ...
        for (int i = 0; i < j; i++) {
            KafkaDisconnectOption option = arrayOfConnectOption[i];
    ...
    public Class<? extends ActionEngine> getEngineClass() {
        return KafkaDisconnectActionEngine.class;
    }
